...
import vivi.exphoton.util.barrel.BarrelBlockEntity;
...
public class BlockEntityInit {
    ...
    public static void init() {
        ...
        BARREL_BLOCK_ENTITY = register(BLOCK_ENTITY_TYPE, "photon:barrel", BlockEntityType.Builder.create(BarrelBlockEntity::new, BlockInit.BARREL).build(null));
    }
}
